...
var MediaQuery = class {
  ...
  constructor(query, matches) {
    ...
    __privateAdd(this, _subscribe, createSubscriber((update) => {
      return on(__privateGet(this, _query), "change", update);
    }));
    __privateSet(this, _query, window.matchMedia(`(${query})`));
  }
  get current() {
    __privateGet(this, _subscribe).call(this);
    return __privateGet(this, _query).matches;
  }
};
_query = new WeakMap();
...
//# sourceMappingURL=chunk-OXSZ3GQV.js.map
