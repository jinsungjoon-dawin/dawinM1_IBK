...
function assign_and(object, property, value, location) {
  return compare(object[property] && (object[property] = value), object[property], property, location);
}
  ...
  if (typeof value === "object" && value !== null) {
    ...
    if (is_array(value)) {
      ...
      for (let i = 0; i < value.length; i += 1) {
        copy.push(clone(value[i], cloned, true_default ? `${path}[${i}]` : path, paths));
      }
      return copy;
    }
...
//# sourceMappingURL=chunk-IHX2XGGP.js.map
